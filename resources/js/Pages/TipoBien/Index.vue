<template>
    <ManagmentLayout title="Lista de Tipos de Bienes">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100" v-for="item in items" :key="item">
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <AuthPermission menu="Gestionar Tipo Bien" accion="Ver">
                                <VerButton :href="route('tipoBien.show', { id: item.id })" />
                            </AuthPermission>

                            <AuthPermission menu="Gestionar Tipo Bien" accion="Editar">
                                <EditarButton :href="route('tipoBien.edit', { id: item.id })" />
                            </AuthPermission>

                            <AuthPermission menu="Gestionar Tipo Bien" accion="Eliminar">
...
import { hideLoading, showLoading } from '@/state';
    ...
    const deleteItem = () => {
        if (selectedItem.value) {
            showLoading()
            router.delete(route('tipoBien.destroy', { id: selectedItem.value }), {
