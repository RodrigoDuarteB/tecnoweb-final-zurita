...
text-gray-500 bg-gray-100 border border-gray-300 cursor-default
...
rounded-md hover:text-gray-500 focus:outline-none focus:ring
...
011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
 ...
 class="relative inline-flex items-center px-4 py-2 ml-3 text-sm
font-medium text-gray-500 bg-gray-100 border border-gray-300
...
hover:text-gray-400 focus:z-10 focus:outline-none focus:ring
ring-gray-300 focus:border-blue-300 active:bg-gray-100
...
active:text-gray-700 transition ease-in-out duration-150"
 ...
 class="relative inline-flex items-center px-4 py-2 -ml-px text-sm
font-medium text-gray-700 bg-white border border-gray-300 cursor-default
 leading-5">
                                {{ link.label }}
                        </span>
                    </div>
